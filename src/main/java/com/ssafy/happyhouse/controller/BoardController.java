...
public class BoardController {
    ...
    @ApiOperation(value = "특정 제목을 포함하는 게시글의 목록을 반환한다.", response = List.class)
    @GetMapping("/search")
    public ResponseEntity<List<Board>> getBoardList(String text) throws Exception {
    	logger.debug("getBoardList - 호출");
    	return new ResponseEntity<List<Board>>(boardService.getBoardList(text) , HttpStatus.OK);
    }
